package com.org.myapp.demo.springbootadminserver.config;
...
@Configuration
@EnableWebSecurity
public class SpringBootAdminServerConfig extends WebSecurityConfigurerAdapter{
    private final AdminServerProperties adminServer;

    public SpringBootAdminServerConfig(AdminServerProperties adminServer) {
